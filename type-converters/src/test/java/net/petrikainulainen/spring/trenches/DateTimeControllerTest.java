...
public class DateTimeControllerTest {
    ...
    public void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new DateTimeController(dateTimeService))
                .setConversionService(dateTimeConversionService())
                .build();
    }

    private FormattingConversionService dateTimeConversionService() {
        FormattingConversionService dateTimeConversionService = new FormattingConversionService();

        dateTimeConversionService.addConverter(new LocalDateConverter(ISO_DATE_FORMAT));
        dateTimeConversionService.addConverter(new LocalDateTimeConverter(ISO_DATE_TIME_FORMAT));

        return dateTimeConversionService;
    }
